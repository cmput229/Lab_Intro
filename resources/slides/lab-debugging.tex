...
\frame{
  ...
  \begin{itemize}
    ...
    \item Set a breakpoint by right clicking on the instruction QTSPIM, or
...
\frame{
  ...
  \begin{itemize}
    \item Click the ``Single Step'' button in QTSPIM.
...
\frame{
  ...
  \begin{itemize}
    ...
    \item In QTSPIM, the registers are listed in the left pane, and values in
